...
public class PgCompatibleCallableStatement implements CallableStatement {
    static Function<CallableStatement, String> formatter = CallableStatement::toString;

    private static final Logger log = LogManager.getLogger("pg-statement");

    private final CallableStatement callableStatement;

    public PgCompatibleCallableStatement(CallableStatement callableStatement) {
    ...
    public String toString() {
        return formatter.apply(callableStatement);
    }
}
